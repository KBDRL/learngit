...
class NotTrigger(Trigger):
    def __init__(self, a):
        self.a = a
    def evaluate(self, story):
        return not self.a.evaluate(story)
...
class AndTrigger(Trigger):
    def __init__(self, a, b):
        ...
        self.b = b
    def evaluate(self, story):
        return self.a.evaluate(story) and self.b.evaluate(story)
...
class OrTrigger(Trigger):
    def __init__(self, a, b):
        ...
        self.b = b
    def evaluate(self, story):
        return self.a.evaluate(story) or self.b.evaluate(story)
